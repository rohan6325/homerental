    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Renter's Paradise!</div>
                          ...
                          echo '</div>
                            ...
                            echo '<p><b>Description: </b>'.$value['description'].'</p>';
                              if($value['vacant'] == 0){ 
                                ...
                                echo '<button class="btn btn-success" data-toggle="modal"><a href="https://www.google.com/maps/place/' . $value['address'] . '">Location</a></button>';
